                            ...
                            <table class="table">
                                ...
                                @foreach($venues as $venue)
                                    <tr>
                                        ...
                                        <td>
{{--                                            <a href="{{url('/edit/venue2/'.$venue->id)}}" class="btn btn-info btn-sm" style="padding-left: 7%;padding-right: 7%;">Edit</a>--}}
                                            <a href="{{url('/edit/venue2/'.$venue->id)}}" title="Edit" style="font-size: 20px;color: darkgray !important;"> <i class="fa fa-edit"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
