...
<link rel="stylesheet" href="{{asset('asset/build/css/intlTellnput2.css')}}">
<style>
    #geomap{
        width: 100%;
        height: 400px;
                            ...
                            <table class="table">
                                ...
                                @foreach($venues as $venue)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('edit/venue2/'.$venue->id)}}" style="font-size: 20px;color: darkgray !important;"> <i class="fa fa-edit"></i> </a>
