...
{{--                                                <i class="fa fa-edit" title="Edit" id="{{$value->id}}" style="color: darkgray;font-size: 20px;"></i>--}}
                                                <a href="{{url('/edit/admin/'.$value->id)}}"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select name="organization" class="organization" style="border: none; width: 259px;margin-top: 6%;" >
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        <label class="form-label">Email</label>
                                        <div class="form-line">
                                            <input type="email" name="edit_email" class="form-control" style="outline: none;background-color: #FFFFFF;" id="edit_email"  readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label for="title">Organization</label> <br/>
                                        <select name="edit_organization" id="edit_organization" style="border: none; width: 259px;margin-top: 6%;" >
                                            @foreach($organizations as $organization)
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        <label for="phone">Contact (format: xxx-xxx-xxxx)</label><br/>
                                        <div class="form-line">
{{--                                            <input type="text" name="edit_phone"  maxlength="100" class="form-control edit_phone"  id="edit_phone" >--}}
                                            <input  id="edit_phone" class="phone form-control edit_phone" name="edit_phone" type="tel" pattern="\d{3}[\-]\d{3}[\-]\d{4}" style="border: none;"  >
