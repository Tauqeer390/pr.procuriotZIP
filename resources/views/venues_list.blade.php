                ...
                @foreach ($venues as $venue)
                    <tr>
                        ...
                        <td> <button class="btn btn-info btn-sm btn_edit_venue" id="{{ $venue->id }}">Edit</button>
                            <button class="btn btn-danger btn-sm btn_delete_venue"
                                id="{{ $venue->id }}">Delete</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group input-group">
                                                        <input type="text" id="search_location" class="form-control"
                                                            ...
                                                            placeholder="Enter location name and press locate button">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="name" maxlength="100"
                                            class="form-control edit_venue_name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="description"
                                            class="form-control edit_venue_description" required>
                                    </div>
                                </div>
                            </div>
