    ...
    <section class="content" style="margin-top: 0px !important;">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <form id="add_categoryForm" method="post" action="{{ route("categories.store") }}" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    {{-- <div class="row" style="margin-top: 1%;">
                        <div class="col-md-12" style="text-align: right;">
                            <button type="submit" class="btn add_category_btn"
                                style="background-color: #6860FF;color: white;margin-right: 1%;width: 6%;">Add</button>
    ...
    <script>
        ...
        $(document).ready(function () {
            var route = "{{ route('categories.store') }}";
                $('#add_categoryForm').submit(function(evt) {
                    $.ajax({
                    url: route,
                    type: "POST",
