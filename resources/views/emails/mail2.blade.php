...
<div class="container" style="border: 2px solid lightgray;">
    ...
    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12">
            <P style="font-size: 13px;padding-left: 2%;padding-top: 2%"> Hi , {{ \App\User::where(['email' => $username])->pluck('first_name')->first() . ' ' . \App\User::where(['email' => $username])->pluck('last_name')->first()  }}</P>
            <br>
            <p style="font-size: 14px;padding-left: 2%;">You can use following credentials to login to your procuriot account:</p>
        </div>
    </div>
    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12">
            <p style="font-size: 14px;padding-left: 2%;">Username: {{$username}} <br/> password: {{$password}}</p>
        </div>
    </div>

    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12">
            <p style="font-size: 14px;padding-left: 2%;"> Click on the link below to verify your account first:</p>
        </div>
    </div>

    <div class="row" style="border-bottom: 2px solid lightgray;">
        <div class="col-md-12" style="text-align: center;">
            <a class="btn btn-primary" style="font-size: 14px;" href="{{$link}}">Click here to verify your account</a>
        </div>
    </div>
