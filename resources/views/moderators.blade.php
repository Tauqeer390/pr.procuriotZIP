...
{{--                                                <i class="fa fa-edit" title="Edit" id="{{$value->id}}" style="color: darkgray;font-size: 20px;"></i>--}}
                                                <a href="{{url('/edit/moderator/'.$value->id)}}"
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="first_name"  maxlength="100" class="form-control" id="first_name" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="last_name"  maxlength="100" class="form-control" id="last_name" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="organization" value="@if($organization->name) {{$organization->name}} @endif"  maxlength="100" class="form-control" id="organization"  readonly>
                                        </div>
                                    </div>
                                </div>
...
{{--                                        <div class="form-line">--}}
{{--                                            <input type="number" name="phone"  maxlength="100" class="form-control" id="phone" >--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            ...
                                            <input  id="phone" class="phone form-control" name="phone" type="tel" pattern="\d{3}[\-]\d{3}[\-]\d{4}" style="border: none;"  >
...
{{--                                </div>--}}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="address"  maxlength="100" class="form-control" id="address" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        <label class="form-label">First Name</label>
                                        <div class="form-line">
                                            <input type="text" name="edit_first_name"  maxlength="100" class="form-control" id="edit_first_name" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        <label class="form-label">Last Name</label>
                                        <div class="form-line">
                                            <input type="text" name="edit_last_name"  maxlength="100" class="form-control" id="edit_last_name" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group form-float">
                                        <label class="form-label">Organization</label>
                                        <div class="form-line">
                                            <input type="text" name="edit_organization" value="{{$organization->name}}" placeholder="{{$organization->name}}"  maxlength="100" class="form-control" id="edit_organization"  readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            {{--                                            <input id="phone" class="phone" name="phone" class="phone" type="tel" style="border: none;">--}}
                                            <input  id="edit_phone" class="phone form-control" name="edit_phone" type="tel" pattern="\d{3}[\-]\d{3}[\-]\d{4}" style="border: none;"  >
...
{{--                                </div>--}}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group form-float">
                                        <label class="form-label">Address</label>
                                        <div class="form-line">
                                            <input type="text" name="edit_address"  maxlength="100" class="form-control" id="edit_address" >
                                        </div>
                                    </div>
                                </div>
