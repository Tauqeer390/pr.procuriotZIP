            ...
            <ul class="list">
                ...
                <li>
                    <a href="{{ route('categories.index') }}">
                        <i class="fa fa-list-alt" style="margin-top: 3%;font-size: 17px;"></i>
...
{{--                    <li class="header">MAIN NAVIGATION</li>--}}
                    <li>
                        <a href="/venues/list/for/moderator">
                            <i class="fa fa-university" style="margin-top: 3%;font-size: 17px;"></i>
                    ...
                    <li>
                        <a href="/vendors/show/to/moderator">
                            <i class="fa fa-bullseye" style="margin-top: 3%;font-size: 23px;"></i>
                            <span style="margin-top: 4%;">Vendors</span>
                        </a>
                    </li>

{{--                    <li>--}}
{{--                        <a href="/gatewaysForModerators">--}}
